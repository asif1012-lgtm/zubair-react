...
export default function Confirmation() {
  ...
  return (
    <>
      ...
      />
      <div className="min-h-screen flex justify-center items-center p-3 sm:p-4 bg-gradient-to-br from-[#0180FA]/50 via-[#f0f2f5] to-[#0180FA]/60 animate-gradient bg-[length:400%_400%]">
