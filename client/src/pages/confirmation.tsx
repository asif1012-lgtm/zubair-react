...
export default function Confirmation() {
  ...
  return (
    <>
      ...
      />
      <div className="min-h-screen flex justify-center items-center p-3 sm:p-4 bg-gradient-to-tr from-blue-500 via-white to-blue-400 animate-gradient bg-[length:200%_200%]">
