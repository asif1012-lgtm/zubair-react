      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 bg-white">
        ...
        <Link href="/validation">
          <Button 
            ...
            className="px-6 sm:px-7 md:px-8 py-2 sm:py-2.5 rounded-md bg-[#0180FA] hover:bg-[#0180FA]/90 text-sm sm:text-base transition-colors duration-200"
          >
            Apply
        ...
        <p className="mt-3 sm:mt-4 text-[13px] sm:text-[15px] md:text-[17px] text-[#0180FA]">Sign up now for creators</p>
        ...
        <a href="#" className="mt-2 text-xs sm:text-sm text-[#0180FA] hover:underline">Meta support for businesses</a>
